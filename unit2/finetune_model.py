...
def train(
    ...
    for epoch in range(num_epochs):
        for step, batch in tqdm(enumerate(train_dataloader), total=len(train_dataloader)):
            ...
            if (step+1)%save_model_every == 0:
                image_pipe.save_pretrained(model_save_name+f'step_{step+1}', push_to_hub=True, repo_name="DiningSystem/xray_diffuser")
    ...
    image_pipe.save_pretrained(model_save_name, push_to_hub=True, repo_name="DiningSystem/xray_diffuser")
